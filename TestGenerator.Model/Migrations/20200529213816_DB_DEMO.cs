...
{
    public partial class DB_DEMO : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnswserId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorizedAttempts = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExamId = table.Column<int>(nullable: false),
                    UserId = table.Column<string>(nullable: false),
                    ParticipationDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "UserName", "Password", "Email", "Firstname", "Lastname" },
                values: new object[,]
                {
                    {
                        Guid.NewGuid().ToString(),
            ...
            migrationBuilder.InsertData(
                table: "Modules",
                columns: new[] { "ModuleId", "Title", "Description" },
                values: new object[,]
                {
                    {
                        1,
                        "Le c-sharp pour les nuls",
                        "Cours de C# pour débutants"
                    }
                });
        }
